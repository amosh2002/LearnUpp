...
abstract class GetMyProfileVideosUseCase : ParameterlessUseCase<Flow<List<Video>>>()

class GetMyProfileVideosUseCaseImpl(
    private val repo: VideosRepository
) : GetMyProfileVideosUseCase() {
    override fun invoke(): Flow<List<Video>> = repo.getMyProfileFeed()
}
