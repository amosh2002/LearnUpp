...
abstract class GetGlobalReelsUseCase : ParameterlessUseCase<Flow<List<Reel>>>()

class GetGlobalReelsUseCaseImpl(
    private val repo: ReelsRepository
) : GetGlobalReelsUseCase() {
    override fun invoke(): Flow<List<Reel>> = repo.getGlobalFeed()
}
