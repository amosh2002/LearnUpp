...
import com.mcp.ui.base.McpBottomNavBar
import com.mcp.ui.base.McpTopAppBar
import com.mcp.ui.base.AppTheme
import com.mcp.ui.home.HomeScreen
import com.mcp.util.MCPNonPrimaryColors
import com.mcp.util.LanguageEnum
import com.mcp.util.LocalizationService
import com.mcp.util.Logger
import com.mcp.util.MCPStrings
import com.mcp.util.Platform
import com.mcp.util.PlatformBackHandler
import com.mcp.util.PreferencesManager
import com.mcp.util.SessionManager
import com.mcp.util.currentPlatform
import com.mcp.util.getValue
import com.mcp.ui.widgets.AlertDialogWithBlur
            ...
            if (loadingState.value) {
                ...
                Navigator(startScreen) { navigator ->
                    Box(
                        ...
                        Scaffold(
                            topBar = { McpTopAppBar() },
                            bottomBar = { McpBottomNavBar() },
                            snackbarHost = {
                                SnackbarHost(
                                    hostState = LocalSnackBarHostState.current.value,
                                    snackbar = { snackBarData ->
                                        Snackbar(
                                            containerColor = MCPNonPrimaryColors.VERY_LIGHT_GRAY,
                        ...
                        SessionManager.logoutEvents.collect {
                            if (navigator.lastItem !is LoginScreen) {
                                dialogState.value = DialogParams(
                                    title = MCPStrings.FAILED_TO_AUTHENTICATE.getValue(),
                                    message = MCPStrings.PLEASE_LOG_IN_AGAIN.getValue(),
...
data class DialogParams(
    ...
    val confirmText: String = MCPStrings.CONFIRM.getValue(),
    val dismissText: String = MCPStrings.CANCEL.getValue(),
...
fun Navigator.safePop(
    ...
    if (askBeforeGoingBack.value == true) {
        dialogState.value =
            DialogParams(
                title = MCPStrings.LEAVE_TITLE.getValue(),
                message = MCPStrings.LEAVE_TEXT.getValue(),
                dialogType = DialogType.QUESTION,
                buttonCount = 2,
                confirmText = MCPStrings.LEAVE.getValue(),
                dismissText = MCPStrings.GO_BACK.getValue(),
                onConfirm = {
